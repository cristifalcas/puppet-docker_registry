...
class docker_registry (
  ...
  $log_hooks_mail_disabled      = $::docker_registry::params::log_hooks_mail_disabled,
  $log_hooks_mail_levels        = $::docker_registry::params::log_hooks_mail_levels,
  $log_hooks_mail_smtp_addr     = $::docker_registry::params::log_hooks_mail_smtp_addr,
  $log_hooks_mail_smtp_username = $::docker_registry::params::log_hooks_mail_smtp_username,
  $log_hooks_mail_smtp_password = $::docker_registry::params::log_hooks_mail_smtp_password,
  $log_hooks_mail_smtp_insecure = $::docker_registry::params::log_hooks_mail_smtp_insecure,
  $log_hooks_mail_from          = $::docker_registry::params::log_hooks_mail_from,
  $log_hooks_mail_to            = $::docker_registry::params::log_hooks_mail_to,
  $storage_type                 = $::docker_registry::params::storage_type,
  $filesystem_rootdirectory     = $::docker_registry::params::filesystem_rootdirectory,
  $azure_accountname            = $::docker_registry::params::azure_accountname,
  $azure_accountkey             = $::docker_registry::params::azure_accountkey,
  $azure_container              = $::docker_registry::params::azure_container,
  $azure_realm                  = $::docker_registry::params::azure_realm,
  $gcs_bucket                   = $::docker_registry::params::gcs_bucket,
  $gcs_keyfile                  = $::docker_registry::params::gcs_keyfile,
  $gcs_rootdirectory            = $::docker_registry::params::gcs_rootdirectory,
  $s3_accesskey                 = $::docker_registry::params::s3_accesskey,
  $s3_secretkey                 = $::docker_registry::params::s3_secretkey,
  $s3_region                    = $::docker_registry::params::s3_region,
  $s3_bucket                    = $::docker_registry::params::s3_bucket,
  $s3_encrypt                   = $::docker_registry::params::s3_encrypt,
  $s3_secure                    = $::docker_registry::params::s3_secure,
  $s3_v4auth                    = $::docker_registry::params::s3_v4auth,
  $s3_chunksize                 = $::docker_registry::params::s3_chunksize,
  $s3_rootdirectory             = $::docker_registry::params::s3_rootdirectory,
  $rados_poolname               = $::docker_registry::params::rados_poolname,
  $rados_username               = $::docker_registry::params::rados_username,
  $rados_chunksize              = $::docker_registry::params::rados_chunksize,
  $swift_username               = $::docker_registry::params::swift_username,
  $swift_password               = $::docker_registry::params::swift_password,
  $swift_authurl                = $::docker_registry::params::swift_authurl,
  $swift_tenant                 = $::docker_registry::params::swift_tenant,
  $swift_tenantid               = $::docker_registry::params::swift_tenantid,
  $swift_domain                 = $::docker_registry::params::swift_domain,
  $swift_domainid               = $::docker_registry::params::swift_domainid,
  $swift_insecureskipverify     = $::docker_registry::params::swift_insecureskipverify,
  $swift_region                 = $::docker_registry::params::swift_region,
  $swift_container              = $::docker_registry::params::swift_container,
  $swift_rootdirectory          = $::docker_registry::params::swift_rootdirectory,
  $swift_trustid                = $::docker_registry::params::swift_trustid,
  $swift_chunksize              = $::docker_registry::params::swift_chunksize,
  $storage_delete               = $::docker_registry::params::storage_delete,
  $storage_redirect             = $::docker_registry::params::storage_redirect,
  $storage_cache_blobdescriptor = $::docker_registry::params::storage_cache_blobdescriptor,
  $auth_type                    = $::docker_registry::params::auth_type,
  $auth_token_realm             = $::docker_registry::params::auth_token_realm,
  $auth_token_service           = $::docker_registry::params::auth_token_service,
  $auth_token_issuer            = $::docker_registry::params::auth_token_issuer,
  $auth_token_rootcertbundle    = $::docker_registry::params::auth_token_rootcertbundle,
  $auth_htpasswd_realm          = $::docker_registry::params::auth_htpasswd_realm,
  $auth_htpasswd_path           = $::docker_registry::params::auth_htpasswd_path,
  $http_addr                    = $::docker_registry::params::http_addr,
  $http_net                     = $::docker_registry::params::http_net,
  $http_prefix                  = $::docker_registry::params::http_prefix,
  $http_host                    = $::docker_registry::params::http_host,
  $http_secret                  = $::docker_registry::params::http_secret,
  $http_tls                     = $::docker_registry::params::http_tls,
  $http_tls_certificate         = $::docker_registry::params::http_tls_certificate,
  $http_tls_key                 = $::docker_registry::params::http_tls_key,
  ...
  $redis_dialtimeout            = $::docker_registry::params::redis_dialtimeout,
  $redis_readtimeout            = $::docker_registry::params::redis_readtimeout,
  $redis_writetimeout           = $::docker_registry::params::redis_writetimeout,
  $redis_pool_maxidle           = $::docker_registry::params::redis_pool_maxidle,
  $redis_pool_maxactive         = $::docker_registry::params::redis_pool_maxactive,
  $redis_pool_idletimeout       = $::docker_registry::params::redis_pool_idletimeout,
  $proxy_remoteurl              = $::docker_registry::params::proxy_remoteurl,
